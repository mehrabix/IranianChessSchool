...
import { ChessKnight, Sparkles, Mail, Lock, User, ArrowRight, Eye, EyeOff } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!name || name.length < 2) { setFieldErrors(prev => ({ ...prev, name: 'Name is too short' })); return; }
    if (!email || !email.includes('@')) { setFieldErrors(prev => ({ ...prev, email: 'Enter a valid email' })); return; }
    if (!password || password.length < 8) { setFieldErrors(prev => ({ ...prev, password: 'Password must be at least 8 characters' })); return; }
      ...
      <Card className="relative z-10 w-full max-w-md border-0 shadow-xl shadow-emerald-900/5">
        <CardHeader className="text-center pb-6 pt-8">
          ...
          <CardDescription className="text-sm">
            Start your structured chess journey
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="Your name" value={name} onChange={(e) => setName(e.target.value)} required className="pl-10 h-11" />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPassword ? 'text' : 'password'} placeholder="Min. 8 characters" value={password} onChange={(e) => setPassword(e.target.value)} required className="pl-10 h-11 pr-10" />
